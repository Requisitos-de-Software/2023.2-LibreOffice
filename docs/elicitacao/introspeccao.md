...
| **Formatação do texto (corpo)** | Deve possibilitar que o usuário escolha o alinhamento do texto (centralizado, justificado, à esquerda, à direita), bem como aumentar e reduzir o tamanho do recúo e personalizar o tamanho das margens |
| **Inserção de arquivos** | Deve possibilitar a inclusão de imagens, hiperlinks e conteúdo textual de outras fontes (como páginas web e pdf's) ou de outra parte do mesmo arquivo |
...
| INT02 | O software deve fornecer ferramentas/opções para formatar o texto, como alterar o estilo e o tamanho da fonte | RF |
