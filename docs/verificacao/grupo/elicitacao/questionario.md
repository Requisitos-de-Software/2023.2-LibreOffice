...
|  ID   | Questão                                                                                                                                                                                                                                       | Inspeção |
| :---: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------: |
|   9   | O questionário possui instruções prévias para a realização? [1]                                                                                                                                                                               |    🟢     |
|  10   | Existe uma data limite definida para a aceitação das respostas?        [1]                                                                                                                                                                    |    🟡     |
|  11   | No artefato do questionário, existe alguma documentação que esclarece o propósito dessa técnica no contexto do projeto? Há uma definição explícita dos objetivos pretendidos ao empregar questionários para a obtenção de requisitos? [1] [2] |    🟢     |
|  12   | Ao utilizar a técnica de elicitação de requisitos por meio de questionários, houve alguma priorização de perguntas por parte do grupo? Elas são as primeiras perguntas do questionário? [2]                                                   |    🟡     |
|  13   | O questionário possui perguntas abertas e/ou fechadas relacionadas ao objetivo principal?  [1]                                                                                                                                                |    🟢     |
|  14   | O questionário apresenta perguntas para classificar o público? (gênero, estado, faixa etária, conhecimento sobre o assunto, etc.)?           [1]                                                                                              |    🟢     |
|  15   | Ao utilizar a técnica de elicitação de requisitos por meio de questionários, evitou-se realizar perguntas íntimas que não agregam valor ao resultado final?   [2]         |    🟢     |
|  16   | Foi realizado um questionário teste para avaliar dificuldades e dúvidas que as pessoas tiveram ao responder?    [1]                                                                                                                           |    🔴     |
|  17   | Existe no questionário uma taxa de resposta alvo necessária para cumprir os objetivos da pesquisa?       [1]                                                                                                                                  |    🟡     |
...
> [1] VAZQUEZ, Carlos Eduardo; SIMÕES, Guilherme Siqueira. **Engenharia de Requisitos**: software orientado ao negócio. Rio de Janeiro: Brasport, 2016. [Imagens anexadas](#anexos).

> [2] RETRAINING. **Questionários - Técnicas de Elicitação de Requisitos**. Disponível [clicando aqui](https://retraining.inf.ufsc.br/guia/app/classificacoes/tecnicas-de-elicitacao-de-requisitos/entidades/tecnicas-de-elicitacao-de-requisitos-questionarios). Acesso em: 04 dez. 2023.[Imagens anexadas](#anexos).
...
<p> Figura 2: Texto base para o item 11  do checklist. (Fonte: RETRAINING. Questionários - Técnicas de Elicitação de Requisitos) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_11b.jpeg">
<p> Figura 3: Texto base para o item 11 do checklist. (Fonte: VAZQUEZ, Carlos Eduardo. Engenharia de Requisitos: software orientado ao negócio) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_12.jpg">
<p> Figura 4: Texto base para o item 12 do checklist. (Fonte: RETRAINING. Questionários - Técnicas de Elicitação de Requisitos) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_13a.jpeg">
<p> Figura 5: Texto base para o item 13 do checklist. (Fonte: VAZQUEZ, Carlos Eduardo. Engenharia de Requisitos: software orientado ao negócio) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_13b.jpeg">
<p> Figura 6: Texto base para o item 13 do checklist. (Fonte: VAZQUEZ, Carlos Eduardo. Engenharia de Requisitos: software orientado ao negócio) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_14.jpeg">
<p> Figura 7: Texto base para o item 14 do checklist. (Fonte: VAZQUEZ, Carlos Eduardo. Engenharia de Requisitos: software orientado ao negócio) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_15.jpg">
<p> Figura 8: Texto base para o item 15 do checklist. (Fonte: RETRAINING. Questionários - Técnicas de Elicitação de Requisitos) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_16.jpeg">
<p> Figura 9: Texto base para o item 16 do checklist. (Fonte: VAZQUEZ, Carlos Eduardo. Engenharia de Requisitos: software orientado ao negócio) </p>
</div>

<div style="text-align: center">
<img src="../images/questionario/questionario_17.png">
<p> Figura 10: Texto base para o item 17 do checklist. (Fonte: VAZQUEZ, Carlos Eduardo. Engenharia de Requisitos: software orientado ao negócio) </p>
</div>
</center>