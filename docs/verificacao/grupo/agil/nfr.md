...
| ID  |                                                                                                                                                                                                       Questão                                                                                                                                                                                                        | Inspeção |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------: |
|  9  | O documento elaborado contém todos os tipos de softgoal (Softgoals NFR, Softgoals de Operacionalização e Softgoals de Afirmação) do framework NFR e eles detém a sua correta representação gráfica (softgoals NFR -> nuvens claras, softgoals de operacionalização -> nuvens com linhas mais grossas, e softgoals de afirmação -> nuvens com linhas tracejadas) no documento ? [1]  |    🟢    |
| 10  |                                                                                                                                                  A representação dos Softgoals NFR estão em conformidade com suas definições? [1]                                                          |    🟢    |
| 11  |                                                                                                                                         A representação dos Softgoals de Operacionalização estão em conformidade com suas definições? [1]                                                                                                                                          |    🟢    |
| 12  |                                                                                                                                             A representação dos Softgoals de Afirmação estão em conformidade com suas definições? [1]                                                                                                                                              |    🟢    |
| 13  |                A decomposição de softgoals NFR elaborada no projeto, foi corretamente utilizada para subdividir os macros objetivos em partes menores e mais específicas ? Podendo ser utilizado os 4 tipos de decomposições (Decomposição de Softgoal NFR, Decomposição de Softgoal NFR, Decomposição de Softgoal NFR e Priorização) no documento do projeto. [2]            |    🟢    |
| 14  |                                                                                                                                    No documento, os cartões de especificação representam requisitos não-funcionais que podem ser testáveis?[3]                                                                                                                                    |    🟡    |
| 15  |                                              A aplicação dos tipos de contribuição demonstram como a satisfação ou não de um softgoal descendente contribui para a satisfação do softgoal ascendente ? Os possíveis tipos de contribuição (AND, OR, MAKE, BREAK, HELP, HURT, UNKNOWN, EQUALS, SOME) foram aplicados no projeto ? [4]                                               |    🟢    |
| 16  |                                                            Dado o procedimento de avaliação de softgoals para indicar a satisfação deles. Foi indicado corretamente rótulos (satisfeito, fracamente satisfeito, negado, fracamente negado, conflitante, indeterminado) para as interdependência do SIG no sistema ? [5]                                                            |    🟢    |
...
| ID Correção | Ajuste                       |
| ----------- | ---------------------------- |
| IDC1        | Foi corrigido o link de redirecionamento para o repositório Simplenote |
| IDC2        | Foi incluido legenda na última tabela        |
| IDC3        | Foi especificado as descrições do cartão de especificação de portabilidade e desempenho para que os requisitos possam ser testáveis          |
